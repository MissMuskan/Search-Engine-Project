...
def main():
    ...
    st.set_page_config(
        page_title="Semantic Search Based Movie Title Search Engine Project",
        page_icon="🎬",
        layout="centered",
    ...
    st.markdown("<h1 class='title'>🔍 Semantic Search Based Movie Title Search Engine Project 🎬</h1>", unsafe_allow_html=True)
    ...
    if st.button("Search 🔎"):
        if user_input:
            ...
            client = chromadb.PersistentClient(path=r"C:\Users\Dell\Desktop\New folder\Search Engine db")
